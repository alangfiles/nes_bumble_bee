...
; if(current_settings_choice == SETTING_SONG){
;
L2707:	lda     _current_settings_choice
	cmp     #$02
	bne     L22D3
;
...
;
	jmp     L2774
L2777:	lda     _current_settings_choice
	cmp     #$01
	bne     L2778
;
; temp_y = 128;
